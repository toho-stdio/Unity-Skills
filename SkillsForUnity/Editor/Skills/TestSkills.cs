...
#endif
        private const string MissingTestFrameworkMessage = "Unity Test Framework package is not installed. Add com.unity.test-framework to use test runner skills.";
...
";
        ...
        private static object CreateTestFrameworkUnavailableResponse()
        {
            return new { error = MissingTestFrameworkMessage };
        }
    }
}
